...
http.createServer(function (req, res) {
  if (req.url.indexOf('/img') != -1) {
    ...
    fs.readFile(__dirname + '/app/img' + filePath, function (err, data) {
    ...
    fs.readFile(__dirname + '/app/js' + filePath, function (err, data) {
      if (err) console.log(err);
    ...
    fs.readFile(__dirname + '/app/css' + filePath, function (err, data) {
      if (err) console.log(err);
